...
function createLabelStyle(feature, resolution) {
  ...
  const silttrapsGeojson = new ol.layer.VectorImage({
    source: new ol.source.Vector({
      url: './resources/shapefiles/Silt_traps.geojson',
      format: new ol.format.GeoJSON()
    }),
    visible: false,
    title: 'siltTrap',
  ...
  const bundsGeoJSON = new ol.layer.VectorImage({
    source: new ol.source.Vector({
      url: './resources/shapefiles/Stonebunds.geojson',
      format: new ol.format.GeoJSON()
    }),
    style: new ol.style.Style({
